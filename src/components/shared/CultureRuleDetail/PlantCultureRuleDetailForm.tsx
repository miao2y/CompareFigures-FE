...
import PlantWorkScheduleTypeRadio from "../WorkSchedule/PlantWorkScheduleTypeRadio";

const PlantCultureRuleDetailForm = (props: {
    ...
    <div>
      ...
      >
        ...
        <Form.Item
          ...
          label="工作类型"
          name="type"
          initialValue={WorkType.种苗}
        >
          <PlantWorkScheduleTypeRadio />
        </Form.Item>
        <Form.Item
          label="是否为全局规则"
          name="isGlobalRule"
          valuePropName="checked"
          hidden={!!props.cultureRulePeriodId}
        >
            ...
            form.getFieldValue("repeatType") !== RepeatType.不重复 && (
              ...
              >
                <InputNumber
                  ...
                  style={{ width: 200 }}
                  formatter={(v) =>
                    (v ?? 0) + " " + (form.getFieldValue("repeatType") ?? "")
                  }
                />
              </Form.Item>
            )
...
export default PlantCultureRuleDetailForm;

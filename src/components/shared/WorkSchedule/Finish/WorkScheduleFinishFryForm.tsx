...
import {
  ...
  WorkScheduleApi,
  WorkScheduleDto,
  WorkScheduleFinishFryParam,
} from "../../../../scaffold";
import moment from "moment";
import MaterialSelector from "../../Material/MaterialSelector";

const WorkScheduleFinishFryForm = (props: {
  ...
  const saveHook = useOpenApiFpRequest(
    WorkScheduleApi,
    WorkScheduleApi.prototype.workScheduleFinishFryPost
  );
  useEffect(() => {
  ...
  return (
    <div>
      <Form<WorkScheduleFinishFryParam>
        form={form}
        onFinish={async (data) => {
          await ConfirmAsync({
            title: "确认",
      ...
      >
        ...
        <Form.Item label="放苗数 (尾)" name="count">
...
export default WorkScheduleFinishFryForm;

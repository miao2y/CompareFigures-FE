...
import {
  ...
  WorkScheduleApi,
  WorkScheduleDto,
  WorkScheduleFinishParams,
} from "../../../../scaffold";
import moment from "moment";
import MaterialSelector from "../../Material/MaterialSelector";

const WorkScheduleCommonFinishForm = (props: {
  ...
  const saveHook = useOpenApiFpRequest(
    WorkScheduleApi,
    WorkScheduleApi.prototype.workScheduleCommonFinishPost
  );
  useEffect(() => {
...
export default WorkScheduleCommonFinishForm;

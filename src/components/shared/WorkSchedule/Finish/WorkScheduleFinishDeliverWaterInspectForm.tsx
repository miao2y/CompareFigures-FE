...
import {
  ...
  WorkScheduleApi,
  WorkScheduleDto,
  WorkScheduleFinishDeliverWaterInspectParam,
} from "../../../../scaffold";
import moment from "moment";
import MaterialSelector from "../../Material/MaterialSelector";

const WorkScheduleFinishDeliverWaterInspectForm = (props: {
  ...
  const saveHook = useOpenApiFpRequest(
    WorkScheduleApi,
    WorkScheduleApi.prototype.workScheduleFinishDeliverWaterInspectPost
  );
  useEffect(() => {
  ...
  return (
    <div>
      <Form<WorkScheduleFinishDeliverWaterInspectParam>
        form={form}
        onFinish={async (data) => {
          await ConfirmAsync({
            title: "确认",
          ...
          saveHook
            .request({
              workScheduleFinishDeliverWaterInspectParam: {
                ...
                inspectOrganization: data.inspectOrganization,
              },
            })
            .then(() => {
      ...
      >
        ...
        <Form.Item label="送检机构" name="inspectOrganization">
          <Input placeholder="请输入送检机构" />
        </Form.Item>
...
export default WorkScheduleFinishDeliverWaterInspectForm;

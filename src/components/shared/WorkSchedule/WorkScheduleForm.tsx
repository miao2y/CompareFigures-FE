  ...
  return (
    <div>
      ...
      >
        ...
        >
          <Switch checkedChildren="全天任务" unCheckedChildren="非全天任务" />
        </Form.Item>
        <Space direction={"horizontal"}>
          ...
          <Form.Item label="养殖批次" name="cultureBatchId">
            <CultureBatchSelector placeholder="请选择养殖批次" allowClear />
          </Form.Item>
        </Space>
        <Form.Item label="养殖员工" name="workerId">
          <UserCardSelector theme={"light"} />
        </Form.Item>
